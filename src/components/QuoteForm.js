...
const QuoteForm = () => {
    ...
    return (
        <div className="flex flex-col h-full">
            <div className="mb-8">
                <h5 className="md:text-4xl text-3xl font-black text-slate-900 mb-2 capitalize tracking-tight">
                    Request a <span 
                    style={{
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <div className="pt-2">
                    <button disabled={submitting} className="group relative flex items-center justify-center gap-2 sm:gap-3 w-full px-4 sm:px-8 py-3.5 sm:py-4 bg-gradient-to-r from-[#FF1F8E] to-[#FF0055] rounded-2xl text-white text-xs sm:text-sm font-extrabold tracking-wider sm:tracking-widest uppercase overflow-hidden shadow-lg shadow-pink-600/20 hover:shadow-pink-600/40 transition-all duration-300 disabled:opacity-70">
                        <span className="relative z-10 whitespace-nowrap">{submitting ? "Submitting..." : "Submit Now"}</span>
