...
export default function B2BSalesPage() {
  ...
  return (
    <main className="bg-white pt-36 text-slate-950 md:pt-[100px] lg:pt-[130px]">
      <section className="relative overflow-hidden px-5 pb-20 pt-14 lg:pt-18 sm:px-8 lg:px-12 lg:pb-24">
